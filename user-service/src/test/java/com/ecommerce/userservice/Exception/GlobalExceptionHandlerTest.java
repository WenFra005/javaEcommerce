...
public class GlobalExceptionHandlerTest {
    ...
    ResponseEntity<ErrorResponse> responseEntity = handler.handleHttpMessageNotReadableException(exception, request);
    ...
    void testHandleMethodArgumentNotValidException() {
        ...
        ResponseEntity<ErrorResponse> responseEntity = handler.handleMethodArgumentNotValidException(exception, request);
