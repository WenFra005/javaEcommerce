...
public class UserControllerTest {
    ...
    void testGetUser_OtherUser_ShouldReturnForbidden() throws Exception {
        ...
        when(userService.findUserById(eq(userId), anyString(), any(UserRole.class))).thenThrow(new AccessDeniedException("Acesso negado"));
    ...
    void testPutUser_WithoutAuth_ShouldReturnUnauthorized() throws Exception {
        ...
        verify(userService, never()).updateUser(eq(userId), any(UpdateRequest.class), anyString(), any(UserRole.class));
    }
